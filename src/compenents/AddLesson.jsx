    ...
    return (<ThemeContainer>
        <form method="post" encType="multipart/form-data" className="bg-white mx-auto m-3 rounded-xl p-5 w-[75%]" onSubmit={handleCreateSection}>
            <label htmlFor="sectionTitle">
                ...
                <input type="text" id="sectionTitle" name="title" placeholder="Write here" className="py-2 px-14  rounded shodow-sm bg-color w-full placeholder-gray-400" />
            </label>

            <p className="my-3 font-bold">Content Section</p>
            <textarea id="addSection" name="description" className="py-2 px-14  rounded shodow-sm bg-color w-full placeholder-gray-400 " placeholder="Add section" ></textarea>
