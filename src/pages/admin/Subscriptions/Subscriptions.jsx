  ...
  return (
    <ThemeContainer role="admin">
      ...
      <div className="mx-auto 2xl:w-[75%] flex">
        <Sidebar page="schools" />
        <div className="block w-[80%] p-2">
          <h2 className="block text-2xl my-5 mx-2">{language && language['schools']}</h2>

          <div className="bg-white rounded-2xl">
            <div className="flex justify-between">
              <Link to="/dashboard/new-school" className="rounded pointer m-2 py-2 px-10 bg-gradient-to-br from-[#ffffff] to-[#3600ff] text-sm hover:bg-gradient-to-br hover:from-[#cec0ff] hover:to-[#2d00ce]   font-bold flex text-white">
                <img src="/icons/storieswhite.png" className="w-6" alt="" />
                <span className="mx-2">{language && language["new-school"]}</span>
              </Link>
            </div>
