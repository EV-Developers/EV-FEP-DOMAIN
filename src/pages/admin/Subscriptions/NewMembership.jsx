    ...
    return (
        <ThemeContainer role="admin">
            <form method="post" encType="multipart/form-data" onSubmit={handleAddUser} className="w-[75%] block mx-auto rounded-xl m-5 bg-white p-5">
                ...
                <p className="my-3 font-bold">{language && language["subscription_type"]}</p>
                ...
                <label htmlFor="address" className="block">
                    <p className="my-3 font-bold">{language && language["address"]}</p>
                    <input type="text" id="address" name="address" placeholder={language && language["write_here"]} className="py-2 px-14  rounded shodow-sm bg-gray-200 w-full placeholder-gray-400" />
                </label>
                ...
                <label htmlFor="subscription_date" className="block">
                    <p className="my-3 font-bold">{language && language["subscription_date"]}</p>
                    <input type="date" id="subscription_date" name="subscription_date" placeholder={language && language["write_here"]} className="py-2 px-14  rounded shodow-sm bg-gray-200 w-full placeholder-gray-400" />
                </label>

                <label htmlFor="subscription_years" className="block">
                    <p className="my-3 font-bold">{language && language["subscription_years"]}</p>
                    <input type="number" id="subscription_years" name="subscription_years" placeholder={language && language["write_here"]} className="py-2 px-14  rounded shodow-sm bg-gray-200 w-full placeholder-gray-400" />
                </label>
