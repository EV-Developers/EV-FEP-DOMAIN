...
export default function ACertificates() {
    ...
    return (
        <ThemeContainer role="admin">
            ...
            <div className="mx-auto 2xl:w-[75%] flex">
                <Sidebar page="certifications_issue_orders" />
                <div className="block w-[80%] p-2">
                    <h2 className="block text-2xl my-5 mx-2">{language && language['certifications_issue_orders']}</h2>

                    <div className="bg-white rounded-2xl">
                        <div className="inline-flex bg-[#f0f4fa] rounded-xl mx-3 my-4">
                            <button onClick={() => setTab("students")} className="py-2 px-14 text-center rtl:border-l rtl:border-l-[#000000] ltr:border-r ltr:border-r-[#000000] relative items-center cursor-pointer">
                                <span>{language && language['students']}</span>
                                {tab == "students" && <div class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-br from-[#ffffff] to-[#3600ff] mx-auto"></div>}
                            </button>
