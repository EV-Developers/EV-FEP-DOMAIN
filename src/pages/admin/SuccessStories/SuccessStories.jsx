...
export default function SuccessStories() {
    ...
    const [tab, setTab] = React.useState("content-creators");
    ...
    return (
        <ThemeContainer role="admin">
            ...
            <div className="mx-auto 2xl:w-[75%] flex">
                <Sidebar page="success_stroies" />
                <div className="block w-[80%] p-2">
                    <h2 className="block text-2xl my-5 mx-2">{language && language['success_stroies']}</h2>
