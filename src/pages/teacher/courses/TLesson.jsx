...
export default function TLesson({ courseId, item }) {
    ...
    return (<div id={"lesson-" + item.id} className="px-3 py-5 m-4 rounded-xl transition-all">
        ...
        <div className="transition-all px-0">
            ...
            <div className="justify-baseline">
                <Link to={"/teachers/courses/lesson/"+item.id} className="relative flex justify-center items-center w-[65%] group">
                    <div className="text-amber-600 bg-amber-500 absolute bottom-4 z-10 left-1 my-3 w-[75%] h-3 "></div>
