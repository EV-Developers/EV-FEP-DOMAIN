  ...
  return (
    <div>
      <div className="flex border-b border-gray-200">
        <Link to="/new-resource" className="block rounded pointer my-3 py-1 px-5 bg-gradient-to-br from-[#fa9600] to-[#ffe696] text-sm hover:bg-gradient-to-br hover:from-amber-700 hover:to-amber-400 m-2">{language && language["new"]}</Link>
      </div>
