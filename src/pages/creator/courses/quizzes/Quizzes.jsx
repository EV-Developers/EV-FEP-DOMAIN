  ...
  return (<ThemeContainer>
    ...
    <div className="bg-white mx-auto m-3 rounded-xl p-5 w-[75%]">
      <div className="flex justify-between">
        <div></div>
        <div className="flex">
          {lessonQuizzId && <Link to={`/quizzes/${courseId}/${lessonId}/${lessonQuizzId}/0`} className="block rounded pointer m-4 py-3 px-10 bg-gradient-to-br from-[#fa9600] to-[#ffe696] text-sm hover:bg-gradient-to-br hover:from-amber-700 hover:to-amber-400 font-bold">{language && language["edit"]}</Link>}
