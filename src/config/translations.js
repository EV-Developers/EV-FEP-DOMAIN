export const translation = [
  {
    ...
    video_player_error:
      "Your web browser does not support the video playback try another web browser or update your web brower.",
    file: "File",
    url: "Link (URL)",
    meeting: "Meeting",
    questions: "Questions",
  ...
  },
  {
    ...
    video_player_error:
      "متصفح الانترنت الخاص بك لا يدعم تشغيل الفيديو، جرب متصفح انترنت اخر او قم بتحديث المتصفح لاخر نسخة متوفرة...",
    file: "ملف",
    url: "رابط",
    meeting: "اجتماع",
    questions: "أسئلة",
